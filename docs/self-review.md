...
Due to assignment time constraints, policy selection integration in the frontend remains partially implemented. Backend support and API connectivity were completed, while UI refinement was deferred in favor of prioritizing adjudication engine correctness and backend workflow integrity.
